$(document).ready(function () {
    ...
    $('.hdrcarousel').owlCarousel({
        ...
        nav: true,
        navText : [
                "<img src='/wp-content/uploads/2021/07/left-arrow.png' class='hdrcarousel-nav hdrcarousel-nav--left'>",
                "<img src='/wp-content/uploads/2021/07/right-arrow.png' class='hdrcarousel-nav hdrcarousel-nav--right'>"
                ],
        items: 1,
        autoplay:true,
